...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(howMany) => "${Intl.plural(howMany, zero: 'Carrier', one: 'Carrier', other: 'Carriers')}";

  static m2(howMany) => "${Intl.plural(howMany, zero: 'Customer', one: 'Customer', other: 'Customers')}";

  static m3(param) => "Edit ${param}";

  static m4(emailId) => "An Email has been sent to ${emailId}. Please check your inbox.";

  static m5(param) => "Hello ${param}";

  static m6(howMany) => "${Intl.plural(howMany, zero: 'Order', one: 'Order', other: 'Orders')}";
  ...
  static m11(howMany) => "${Intl.plural(howMany, zero: 'Shipment', one: 'Shipment', other: 'Shipments')}";

  static m12(howMany) => "${Intl.plural(howMany, zero: 'Tenant', one: 'Tenant', other: 'Tenants')}";

  static m13(howMany) => "${Intl.plural(howMany, zero: 'Terminal', one: 'Terminal', other: 'Terminals')}";

  static m14(howMany) => "${Intl.plural(howMany, zero: 'User', one: 'User', other: 'Users')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "orderStatusFilter" : MessageLookupByLibrary.simpleMessage("Filter order status"),
    "ordersTitle" : m6,
    "paramEmpty" : m7,
    "paramFromTo" : m8,
    "paramRequired" : m9,
    ...
    "reservationTime" : MessageLookupByLibrary.simpleMessage("Reservation time"),
    ...
    "shipmentDestination" : MessageLookupByLibrary.simpleMessage("Destination"),
    ...
    "shipmentRejectConfirmation" : MessageLookupByLibrary.simpleMessage("Are you sure you want to reject this delivery?"),
    "shipmentReservationTime" : MessageLookupByLibrary.simpleMessage("Reservation time"),
    "shipmentSerialNumber" : MessageLookupByLibrary.simpleMessage("Serial number"),
    "shipmentSize" : MessageLookupByLibrary.simpleMessage("Shipment size"),
    "shipmentStatus" : MessageLookupByLibrary.simpleMessage("Shipment status"),
    "shipmentStatusFilter" : MessageLookupByLibrary.simpleMessage("Filter shipment status"),
    ...
    "tenantTypeFilter" : MessageLookupByLibrary.simpleMessage("Filter tenant type"),
    "tenantsTitle" : m12,
    ...
    "terminalTypeFilter" : MessageLookupByLibrary.simpleMessage("Filter terminal type"),
    "terminalsTitle" : m13,
    "userName" : MessageLookupByLibrary.simpleMessage("User name"),
    "userType" : MessageLookupByLibrary.simpleMessage("User type"),
    "userTypeFilter" : MessageLookupByLibrary.simpleMessage("Filter user type"),
